      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-md mx-auto mb-8 relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-10 py-3 rounded-full border border-slate-200 bg-white text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
          />
          {searchQuery && (
            ...
            {filteredResources.map((resource) => (
              ...
              >
                {resource.link && resource.link !== '#' ? (
                  <PrefetchLink to={resource.link} importFn={ROUTE_IMPORTS[resource.link]} className="block h-full group bg-white border border-slate-200 hover:border-transparent rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-indigo-900/5 cursor-pointer relative">
                    {/* Colored top border */}
        ...
        {filteredResources.length === 0 && (
          <div className="text-center py-12">
            ...
            <button onClick={() => { setSearchQuery(''); setActiveCategory('all'); }} className="mt-4 text-indigo-600 font-bold hover:text-indigo-500 transition-colors">
              Garbitu bilaketa
            </button>
          </div>
        )}
